    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-teal-800 to-cyan-600 rounded-3xl p-8 text-white">
        ...
        <div className="relative">
          ...
          <h2 className="font-display text-3xl lg:text-4xl font-bold mb-3">{resultsData.title}</h2>
          <p className="text-teal-100 font-medium mb-2">{resultsData.subtitle}</p>
          <p className="text-teal-50 text-sm max-w-2xl leading-relaxed">{resultsData.description}</p>
        </div>
      </div>
      ...
      <div className="section-card">
        ...
        <div className="relative">
          ...
          <div className="space-y-5">
            {resultsData.countingSteps.map((item) => (
      ...
      <div className="section-card">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {resultsData.governmentFormation.map((item, idx) => (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-teal-50">
                <th className="text-left px-4 py-3 text-teal-700 font-semibold rounded-l-lg">Term</th>
                <th className="text-left px-4 py-3 text-teal-700 font-semibold rounded-r-lg">Meaning</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {resultsData.keyConcepts.map((row, idx) => (
      ...
      <div className="did-you-know animate-slide-up">
        ...
        <p className="text-sm leading-relaxed">{resultsData.didYouKnow}</p>
      </div>
    </div>
  );
}
